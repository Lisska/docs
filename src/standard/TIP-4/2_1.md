...
Every TIP4.2.1 compliant contract must implement the `TIP4_2JSON_Metadata` interface and [TIP-6.1](./../TIP-6/1.md) interfaces
...
For added new metadata type of [TIP-4.2.1](2_1.md)
